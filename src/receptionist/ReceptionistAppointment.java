...
public class ReceptionistAppointment implements Initializable{
	@FXML
	...
	@FXML
	private TextField tfAddress, tfEmail, tfIssue, tfPhone;
	@FXML
	...
	public void onUpdate() throws SQLException {
		  ...
		  )
		{
			...
			preparedStatement.setInt(9, tvID.getCellData(model));
